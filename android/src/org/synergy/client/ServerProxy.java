...
public class ServerProxy {
	...
	private void keyUp (KeyUpMessage keyUpMessage) {
        ...
        try {
            ...
            // forward
            client.keyUp (keyUpMessage.getID (), keyUpMessage.getMask ());
        } catch (Exception e) {
        }
	}
    ...
    private void keyDown (KeyDownMessage keyDownMessage) {
        ...
        // In dvorak:  
        // Key Down:97:8192:38  -- a key
        // Key Down:98:8192:57  -- b key
        // Key Down:99:8192:31  -- c key
        // Key Down:104:8192:44 -- h key 
        //
        // Is the last parameter important?
        // 
        // Right Shift: 61410:8192:62
        // 65:8193:38 -- A 
        // 
        
        client.keyDown (keyDownMessage.getID (), keyDownMessage.getMask ());
...
//        Log.error ("Key Value: " + keyDownMessage.getKey
    ...
    */
	...
	private void mouseRelativeMove (MouseRelMoveMessage mouseRelMoveMessage) {
		client.relMouseMove (mouseRelMoveMessage.getX (), mouseRelMoveMessage.getY ());
	}
